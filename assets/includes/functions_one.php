...
function Wo_ShareFile($data = array(), $type = 0, $crop = true) {
    ...
    $dataSecurity->makeFolder('upload/');
    //}
    //if (!file_exists('upload/files/' . date('Y').'/' . date('m'))) {
    $dataSecurity->makeFolder('upload/files/');
    $dataSecurity->makeFolder('upload/files/'.date('Y').'/');
    $dataSecurity->makeFolder('upload/files/'.date('Y').'/'.date('m').'/');
    // }

    //if (!file_exists('upload/photos/' . date('Y').'/' . date('m'))) {
    $dataSecurity->makeFolder('upload/photos/');
    $dataSecurity->makeFolder('upload/photos/'.date('Y').'/');
    $dataSecurity->makeFolder('upload/photos/'.date('Y').'/'.date('m').'/');
    //}

    //if (!file_exists('upload/videos/' . date('Y').'/' . date('m'))) {
    $dataSecurity->makeFolder('upload/videos/');
    $dataSecurity->makeFolder('upload/videos/'.date('Y').'/');
    $dataSecurity->makeFolder('upload/videos/'.date('Y').'/'.date('m').'/');
    //}

    //if (!file_exists('upload/sounds/' . date('Y').'/' . date('m'))) {
    $dataSecurity->makeFolder('upload/sounds/');
    $dataSecurity->makeFolder('upload/sounds/'.date('Y').'/');
    $dataSecurity->makeFolder('upload/sounds/'.date('Y').'/'.date('m').'/');
    //}
